...
def main():
    ...
    frm_main.pack(padx=80, pady=60, fill=tk.BOTH, expand=1)
...
def populate_main_window(frm_main):
    ...
    ent_radius = FloatEntry(frm_main, width=4, lower_bound=0.0)
    ...
    lbl_radius.grid(row=0, column=0, padx=100, pady=100)
    ent_radius.grid(row=0, column=1, padx=100, pady=100)

    lbl_area.grid(row=1, column=0, padx=100, pady=100)
    lbl_area_result.grid(row=1, column=1, padx=100, pady=100)

    btn_clear.grid(row=2, column=0, padx=100, pady=100, columnspan=4, sticky="w")
